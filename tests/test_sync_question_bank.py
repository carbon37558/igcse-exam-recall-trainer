...
class QuestionBankImporterTests(unittest.TestCase):
    ...
    def test_question_and_answers_keep_excel_letter_subscripts(self):
        self.assertIn({"text": "N", "script": "sub"}, self.by_id["IBHL053"]["question"]["segments"])
        self.assertIn({"text": "N", "script": "sub"}, self.by_id["IBHL054"]["question"]["segments"])
        self.assertIn({"text": "f", "script": "sub"}, self.by_id["IBHL030"]["question"]["segments"])
        self.assertIn({"text": "N", "script": "sub"}, self.by_id["IBHL055"]["answers"][1]["segments"])
        self.assertIn({"text": "N", "script": "sub"}, self.by_id["IBHL055"]["answers"][2]["segments"])
        self.assertIn({"text": "−", "script": "sup"}, self.by_id["IBHL045"]["answers"][1]["segments"])
